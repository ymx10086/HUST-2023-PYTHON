...
def preprocess_data(inputdir,
                     ...
                     eos=None):
    """
    Preprocess the data from Sentiment dataset so it can be used by the
    model. And then used to the model and give the final result.
    ...
    Args:
        inputdir: The path to the directory containing the Sentiment dataset.
    ...
    # ipdb.set_trace()
    print("\t* Transforming words in Sentiment dataset training to indices...")
    ...
    print("\t* Reading data...")
    data = preprocessor.read_data(os.path.join(inputdir, test_file), False)

    print("\t* Transforming words in Sentiment dataset testing to indices...")
    transformed_data = preprocessor.transform_to_indices(data)
    print("\t* Saving result...")
