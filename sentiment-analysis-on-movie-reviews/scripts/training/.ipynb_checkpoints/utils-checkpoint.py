...
from mutils import correct_predictions
...
def train(model,
    ...
    for batch_index, batch in enumerate(tqdm_batch_iterator):
        ...
        logits, probs = model(sentence, sentence_length, model = mode)
...
def validate(model, dataloader, criterion, mode = None):
    """
