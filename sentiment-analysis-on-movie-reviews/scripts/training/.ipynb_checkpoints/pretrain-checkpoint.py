...
def main(train_file,
    ...
    with open(train_file, "rb") as pkl:
        train_data = MyDataset(pickle.load(pkl), max_length = 50)
...
#         print(name,':',parameters.size())
    ...
    for epoch in range(start_epoch, epochs+1):
        ...
        epoch_time, epoch_loss = pretrain(model,
                                        train_loader,
                                        optimizer,
                                        epoch,
                                        max_grad_norm)
        ...
        if epoch_loss > best_score:
            ...
            torch.save({"epoch": 0,
                       ...
                       os.path.join(target_dir, "pretrain_best.pth.tar"))
            print("have saved")
